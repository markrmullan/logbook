...
public final class TestHandler extends SimpleChannelInboundHandler<Object> {
        ...
        if (msg instanceof HttpContent) {
            ...
            if (msg instanceof LastHttpContent) {
                ...
                if (!trailer.trailingHeaders().isEmpty()) {
                    buf.append("\r\n");
                    for (final CharSequence name: trailer.trailingHeaders().names()) {
                        for (final CharSequence value: trailer.trailingHeaders().getAll(name)) {
